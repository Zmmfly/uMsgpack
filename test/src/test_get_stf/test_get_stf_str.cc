...
tgstf_def(fixstr)
{
    ...
    do{
        hd = t_gstf_create_ump("gstf_fixstr.umpk", msgpack, sizeof(msgpack));
        if (hd == nullptr) {
...
tgstf_def(str8)
{
    ...
    do{
        hd = t_gstf_create_ump("gstf_str8.umpk", msgpack, sizeof(msgpack));
        if (hd == nullptr) {
            msg = "create ump handle with pseudo failed";
            break;
        }
...
tgstf_def(str16)
{
    ...
    do{
        hd = t_gstf_create_ump("gstf_str16.umpk", msgpack, sizeof(msgpack));
        if (hd == nullptr) {
            msg = "create ump handle with pseudo failed";
            break;
        }
...
tgstf_def(str32)
{
    ...
    do{
        hd = t_gstf_create_ump("gstf_str32.umpk", msgpack, sizeof(msgpack));
        if (hd == nullptr) {
            msg = "create ump handle with pseudo failed";
            break;
        }
